...
import { getSegurosPersonalesCapitalizacion } from '@/utils/dataUtils.js'

const SegurosPersonalesCapitalizacion = () => {
  const data = getSegurosPersonalesCapitalizacion(
    'segurospersonalescapitalizacion',
  )
