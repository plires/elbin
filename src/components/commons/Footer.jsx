...
const Footer = ({ special }) => {
  return (
    <footer className={special ? 'specialFooter' : ''}>
      <div className='container'>
        <div className='row'>
          <div className={`col-md-6 ${!special ? 'col-lg-3' : ''} column`}>
            <h5>OFICINAS</h5>
            <p>
            ...
            <>
              <div className='col-md-6 col-lg-3 column'>
                ...
                <div className='content_links'>
                  ...
                  <Link
                    className='transition'
                    to='/seguros/corporativos/generales'
                  >
                    Seguros generales
                  </Link>
                </div>
          ...
          <div className={`col-md-6 ${!special ? 'col-lg-3' : ''} column`}>
            {!special ? (
              ...
              <div className='content_web'>www.elbin.com.ar</div>
            )}
          </div>
        </div>
      </div>
