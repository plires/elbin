    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto; background-color: #ffffff;" class="email-container">
      ...
      <tr>
        <td style="vertical-align: middle;">
          ...
          <img src="{base}img-emails/header-email.jpg" style="margin:0; padding:0; border:none; display:block; width: 100%; height: auto;" border="0" alt="header" />
      ...
      <!-- Texto-->
      <tr style="background-color: #20315b;">
      ...
      <tr style="background-color: #FFFFFF;">
        <td style="padding: 40px;">
          ...
          <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 18px; line-height: 28px; color: #575756; text-align: left; font-weight: 400;">
            <strong>Elbin te da las gracias por tu contacto!</strong>
            <br><br>
            en breve un asesor te estará respondiendo.
          </p>
          ...
          <p class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; color: #575756; text-align: right; font-weight: 700;">
            <strong>{name_client}</strong><br>
            <strong>
              <a class="fallback-font" style="margin: 0 0 10px; font-family: 'Montserrat', sans-serif; font-size: 16px; color: #575756; text-align: right; font-weight: 700;" target="_blank" rel="noopener noreferrer" href="mailto:{email_client}"> {email_client}
              </a>
            </strong><br>
          </p>
      ...
      <!-- Boton : BEGIN -->
      <tr style="background-color: #20315b;">
        <td style="background-color: #20315b; text-align: center; padding: 40px;">
      ...
      <tr align="center" style="background-color: #FFFFFF;">
        <td align="center" style="background-color: #FFFFFF;padding: 10px;">
          ...
          <img src="{base}img-emails/logo-footer-email.png" style="margin:0; padding:0; border:none; display:inline-block; width: 102px; height: auto;" alt="logo elbin" />
