    ...
    <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto; background-color: #ffffff;" class="email-container">
      ...
      <tr style="background-color: #FFFFFF;">
        <td style="padding: 40px;">
          ...
          <h2 class="fallback-font" style="margin: 0 0 5px 0; font-family: 'Montserrat', sans-serif; font-size: 14px; line-height: 24px; color: #575756; text-align: left; font-weight: 300;">
            <strong>Hola, Recibiste una nueva consulta desde {origin}</strong>
          </h2>
